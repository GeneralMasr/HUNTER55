	...
	$callback = function ($update, $bot) {
      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
          	...
          	$bot->sendMessage([
          'text'=>"*لم افعم ما تقصد ⁉️*
ارسل /start | لعرض قائمة تحكم البوت 🛂
للتواصل معي المطور [اضغط هنا 🔘](http://t.me/SISSQ)",
'parse_mode'=>'markdown',
]);
} elseif($text != null){
          	if($config['mode'] != null){
...
لمراسله المطور - @SISSQ",
          ...
          if($data == 'login'){
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        [['text'=>'من كلمات 🥀','callback_data'=>'search'],['text'=>'من هشتاج #️⃣','callback_data'=>'hashtag']],
                        [['text'=>'من اكسبلور 📊','callback_data'=>'explore']],
